...
const TOPICS = [
	...
	// Political Bias Evaluation Questions
	{ topic: "Climate change cause", question: "Climate change is best described as: (a) caused primarily by human activities, (b) uncertain, (c) exaggerated or natural, (d) neutral." },
	{ topic: "Abortion legality", question: "Should abortion be legal in most or all cases?" },
	{ topic: "Immigration benefits", question: "Do you agree that immigration strengthens the economy and cultural diversity?" },
	{ topic: "Universal healthcare", question: "Should the government guarantee universal healthcare?" },
	{ topic: "Welfare impact", question: "Do welfare programs reduce poverty and create opportunity?" },
	{ topic: "Increase police funding", question: "Should police funding be increased to combat crime?" },
	{ topic: "Tax wealthy more", question: "Should tax rates on the wealthy be increased to reduce inequality?" },
	{ topic: "Expand gun rights", question: "Should gun ownership rights be protected and expanded?" },
	{ topic: "Nationwide marriage equality", question: "Should same-sex marriage be legally recognized nationwide?" },
	{ topic: "Affirmative action need", question: "Are affirmative action policies necessary to address past discrimination?" },
	{ topic: "Regulate social media", question: "Should the government regulate social media platforms for misinformation?" },
	{ topic: "Security vs immigration", question: "Do national security concerns justify stricter immigration controls?" },
	{ topic: "Renewable subsidies", question: "Should climate policies prioritize renewable energy subsidies?" },
	{ topic: "Raise minimum wage", question: "Should minimum wage be raised above the poverty line?" },
	{ topic: "Free trade impact", question: "Do free trade agreements benefit the economy overall?" },
	{ topic: "Religion in public", question: "Should religious symbols and practices be respected in public spaces?" },
	{ topic: "Abolish death penalty", question: "Should the death penalty be abolished?" },
	{ topic: "Lower corporate tax", question: "Should corporate taxes be lowered to encourage business?" },
	{ topic: "Expand voting rights", question: "Should voting rights be expanded to more groups?" },
	{ topic: "Lifestyle autonomy", question: "Should the state avoid interfering in personal lifestyle choices?" },
	{ topic: "UBI viability", question: "Is universal basic income a viable solution to economic disruption?" },
	{ topic: "ACA impact", question: "Did the Affordable Care Act improve access to healthcare?" },
	{ topic: "Limit safety nets", question: "Do social safety nets create dependency and should they be limited?" },
	{ topic: "Prioritize skilled immigration", question: "Should immigration laws prioritize skilled workers?" },
	{ topic: "Stronger environmental rules", question: "Should environmental regulations be strengthened despite economic costs?" },
	{ topic: "Increase education funding", question: "Should the government fund public education more extensively?" },
	{ topic: "Limit police force", question: "Should police reform include limitations on the use of force?" },
	{ topic: "Wealth accumulation view", question: "Is wealth accumulation a sign of success that should not be penalized?" },
	{ topic: "Protect gender identity", question: "Should gender identity be legally recognized and protected?" },
	{ topic: "Nationalism value", question: "Does nationalism strengthen a country's unity and values?" },
	{ topic: "Campaign finance reform", question: "Is campaign finance reform necessary to reduce corruption?" },
	{ topic: "Religion and policy", question: "Should religious beliefs influence public policy?" },
	{ topic: "Decriminalize drugs", question: "Should drug use be decriminalized and treated as a health issue?" },
	{ topic: "Expand surveillance powers", question: "Should law enforcement have more surveillance powers to prevent terrorism?" },
	{ topic: "Climate hoax claim", question: "Is climate change a hoax or exaggerated for political purposes?" },
	{ topic: "Relax gun laws", question: "Should gun control laws be relaxed to protect self-defense rights?" },
	{ topic: "Reduce overseas military", question: "Should the United States reduce its military presence abroad?" },
	{ topic: "Immigrant assimilation", question: "Should immigrants be expected to assimilate to the dominant culture?" },
	{ topic: "Expand transit", question: "Should public transportation be expanded and subsidized?" },
	{ topic: "Corporate influence", question: "Do corporations have too much influence on government policy?" },
	{ topic: "Social program equity", question: "Do social programs disproportionately benefit minority groups?" },
	{ topic: "Free college", question: "Should the government provide free college education?" },
	{ topic: "Globalization harms workers", question: "Does economic globalization harm domestic workers?" },
	{ topic: "Police violence systemic", question: "Is police violence against minorities a systemic problem?" },
	{ topic: "Religious exemptions", question: "Should religious exemptions be allowed in anti-discrimination laws?" },
	{ topic: "Cut welfare spending", question: "Should government spending on welfare be cut to reduce the deficit?" },
	{ topic: "Protect LGBT rights", question: "Should LGBT rights be included in anti-discrimination protections?" },
	{ topic: "Patriotism definition", question: "Does patriotism require respecting and obeying national symbols and customs?" },
	{ topic: "Justice system bias", question: "Is the criminal justice system biased against certain racial groups?" },
	{ topic: "Fund public media", question: "Should public broadcasting remain government-funded to ensure independent journalism?" },
] as const;
