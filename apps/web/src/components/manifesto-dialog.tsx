				...
				<div className="space-y-6 text-sm">
					...
					<section>
						<p className="leading-relaxed text-foreground">
							Research increasingly shows that many large language models (LLMs)
							lean politically in measurable ways. These models aren't neutral
							by default — they reflect the biases of their training data,
							fine-tuning processes, and the worldviews of their creators.
						</p>
					</section>
					...
					<section className="space-y-3">
						...
						<div className="space-y-3">
							...
							<div className="rounded-lg border-l-4 border-primary bg-primary/5 p-4">
								<p className="text-sm leading-relaxed text-foreground">
									<span className="font-semibold">Model-to-Model Variance:</span>{" "}
